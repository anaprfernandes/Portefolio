...
<a class="menu-link" href="index.php?action=editar_perfil" style="color: darkcyan;text-decoration-line: none">
    ...
    <a class="menu-link" href="index.php?action=aceitar_rejeitar_exames" style="color: darkcyan;text-decoration-line: none"> Aceitar / Rejeitar Marcações </a>
    <a class="menu-link" href="index.php?action=lista_pacientes" style="color: darkcyan;text-decoration-line: none"> Lista Pacientes </a>
