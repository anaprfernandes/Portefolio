%Ler o ficheiro 
Data_Temp = readmatrix("Pt24_VR.txt");
...
threshold = 0.005; % provide the threshold for detecting contractions
...
%        tempo_contracao = tempo_relax(t)-tempo_contract(t);
%        duracao_contracao(t)=tempo_contracao;
%     else
%        duracao_contracao(t)=NaN;
%     end
...
for t=1:8
    if tempo_relax(t)>tempo_contract(t)
        dur_contract_doente(t) = tempo_relax(1,t)-tempo_contract(1,t);
    else
        dur_contract_doente(t)= NaN;
    end
    display(dur_contract_doente(t))
end
